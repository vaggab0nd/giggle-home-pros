...
import { Gavel, Settings, Building2, LogOut, ChevronRight } from "lucide-react";
...
export function ContractorSidebar() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .maybeSingle()
      .then(({ data }) => {
        if (data) setBusinessName((data as any).business_name);
      });
  }, [user]);
          ...
          {!collapsed ? (
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300 mt-0.5">
                  Contractor
                </span>
              </div>
            </div>
